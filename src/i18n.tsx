...
const translations: Record<LanguageCode, Record<string, string>> = {
  pt: {
    ...
    bookings: 'Minhas Reservas', myCars: 'Meus Carros', rentRewards: 'Rent Rewards', promotions: 'Promoções', myAccount: 'Minha Conta', settings: 'Configurações',
    ...
    near: 'Perto de', perDay: '/ dia', noCarsNearby: 'Nenhum carro publicado foi encontrado perto desta localização.',
    carsLoadFailed: 'Não foi possível carregar os carros. Tente novamente.', ownerName: 'Seu nome',
    carModel: 'Modelo do carro', carCategory: 'Categoria', dailyPrice: 'Preço por dia',
    useCurrentLocation: 'Usar localização atual', publish: 'Publicar anúncio',
  ...
  fr: {
    ...
    bookings: 'Mes réservations', myCars: 'Mes voitures', rentRewards: 'Récompenses', promotions: 'Promotions', myAccount: 'Mon compte', settings: 'Paramètres',
    ...
    near: 'Près de', perDay: '/ jour', noCarsNearby: 'Aucune voiture publiée trouvée près de cette localisation.',
    carsLoadFailed: 'Impossible de charger les voitures. Réessayez.', ownerName: 'Votre nom',
    carModel: 'Modèle de la voiture', carCategory: 'Catégorie', dailyPrice: 'Prix par jour',
    useCurrentLocation: 'Utiliser la localisation actuelle', publish: "Publier l’annonce",
  ...
  en: {
    ...
    bookings: 'My bookings', myCars: 'My cars', rentRewards: 'Rent Rewards', promotions: 'Promotions', myAccount: 'My account', settings: 'Settings',
    ...
    perDay: '/ day', noCarsNearby: 'No published cars were found near this location.',
    carsLoadFailed: 'Unable to load cars. Try again.', ownerName: 'Your name',
    carModel: 'Car model', carCategory: 'Category', dailyPrice: 'Price per day',
    useCurrentLocation: 'Use current location', publish: 'Publish listing',
