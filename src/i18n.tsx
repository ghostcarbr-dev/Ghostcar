...
const translations: Record<LanguageCode, Record<string, string>> = {
  pt: {
    ...
    bookings: 'Minhas Reservas', myCars: 'Meus Carros', rentRewards: 'Rent Rewards', promotions: 'Promoções', settings: 'Configurações',
  ...
  fr: {
    ...
    bookings: 'Mes réservations', myCars: 'Mes voitures', rentRewards: 'Récompenses', promotions: 'Promotions', settings: 'Paramètres',
  ...
  en: {
    ...
    bookings: 'My bookings', myCars: 'My cars', rentRewards: 'Rent Rewards', promotions: 'Promotions', settings: 'Settings',
